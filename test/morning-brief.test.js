...
import {MorningBrief,briefSlot,easternMidnight,gatherBrief} from '../src/morning-brief.js';
...
function harness(){
 ...
 const deps={graph,guard,openai:{respond:async()=>({text:'Verified report'})},dropbox:{saveReport:async()=>({path:'report.pdf'})}};
 return {deps,sent};
}
